<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
        @foreach ($records as $record)
            <div class="flex space-x-4 shadow-md rounded-lg p-4 {{ $record->stock == 0 ? 'bg-red-100' : 'bg-white'}} ">
                ...
                <div class="flex-1 relative">
                    ...
                    <a href="{{$record->listen_url}}">
                        <x-si-musicbrainz class="h-6 w-6 text-red-600" />
                    </a>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        @foreach ($genres as $genre)
            <div class="flex space-x-4 bg-white shadow-md rounded-lg p-4">
                <div class="flex-none w-36 border-r border-gray-200 pe-4">
    ...
    <x-tmk.livewire-log :genres="$genres" :records="$records" />
</div>
